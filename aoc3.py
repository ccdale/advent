...
def findDimensions(moves):
    horiz = vert = top = bottom = left = right = 0
    for d, l in moves:
        if d == "R":
            horiz += l
            if right < horiz:
